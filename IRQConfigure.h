 ...
 */
static const int32_t NiRoborio_Status_Success = 0;
 ...
 */
static const int32_t NiRoborio_Status_IrqChannelNotUsable = -363024;

/**
 * The specified IRQ Number is out of range or 
 * already registered an interrupt with the same interrupt number.
 */
static const int32_t NiRoborio_Status_IrqNumberNotUsable = -363025;
...
typedef enum
{
    Irq_Ai_B0,          /* AI Interrupt on PIN3 from Connector B */
    Irq_Ai_B1,          /* AI Interrupt on PIN5 from Connector B */
    Irq_Dio_B0,         /* DI Interrupt on PIN11 from Connector B */
    Irq_Dio_B1,         /* DI Interrupt on PIN13 from Connector B */
    Irq_Dio_B2,         /* DI Interrupt on PIN15 from Connector B */
    Irq_Dio_B3,         /* DI Interrupt on PIN17 from Connector B */
